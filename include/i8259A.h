...
#define i8259A_ICW1(arg) ((arg) | 0x10)
#define i8259A_ICW1_ADDR(arg) (arg)
...
#define i8259A_ICW2(arg) (arg)
#define i8259A_ICW2_ADDR(arg) ((arg) | 0x1)

/* #########
 * # ICW3: #
 * ######### */

#define i8259A_ICW3(arg) (arg)
#define i8259A_ICW3_ADDR(arg) ((arg) | 0x1)

/* #########
 * # ICW4: #
 * ######### */

#define i8259A_ICW4(arg) (arg)
#define i8259A_ICW4_ADDR(arg) ((arg) | 0x1)
...
#define i8259A_OCW1(arg) (arg) /* for consistency's sake */
#define i8259A_OCW1_ADDR(arg) ((arg) | 0x1)
...
#define i8259A_OCW2(arg) (arg)
#define i8259A_OCW2_ADDR(arg) (arg)

/* An IR level encoded in bits `0' - `2' in OCW2. Used only with certain
 * commands. */
#define i8259A_OCW2_IR(arg) (arg)
...
#define i8259A_OCW3(arg) ((arg) | 0x8)
#define i8259A_OCW3_ADDR(arg) (arg)
