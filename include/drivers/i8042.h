 ...
 * TODO: find out what that "(output)" means and adjust#define  name and
 * description then! */
 ...
 * TODO: find out what that "(input)" means and adjust#define  name and
 * description then! */
...
uint8_t i8042_rd_inp(void);
uint8_t i8042_rd_outp(void);
void i8042_wr_outp(uint8_t b);

void i8042_win_empty(void);
void i8042_wout_full(void);

void i8042_wr_cmd(uint8_t b);

void i8042_wr_data(uint8_t b);
uint8_t i8042_rd_data(void);
